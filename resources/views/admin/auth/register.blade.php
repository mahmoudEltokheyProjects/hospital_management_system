...
@section('title')
    إنشاء مُستخدم جديد - برنامج الفواتير
@stop
@section('css')
                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            <h2>مرحبا بك</h2>
                                            <h5 class="font-weight-semibold mb-4"> إنشاء مُستخدم جديد</h5>
                                            <form method="POST" action="{{ route('register') }}">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="name">{{ __('اسم المستخدم') }}</label>
                                    ...
                                    <span> هل لديك حساب ؟ </span><a href="{{ url('/' . $page='login') }}">تسجيل الدخول</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- End -->
            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div class="row wd-100p mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                        <img src="{{URL::asset('assets/img/user.jpg')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
                    </div>
                </div>
            </div>
